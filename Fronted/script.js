...
window.onload = () => {
    setTimeout(() => {
        ...
        // Esconde la pantalla de bienvenida después de la animación
        setTimeout(() => {
            welcomeScreen.style.display = "none";
            document.getElementById("map-container").style.display = "block";
            initMap();
        }, 1000); // Espera un segundo para que termine la transición
    }, 3000); // 3 segundos de bienvenida
};

// Inicializa el mapa y configura la capa de tráfico
function initMap() {
